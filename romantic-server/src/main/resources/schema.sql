...
CREATE TABLE IF NOT EXISTS countdown_plan (
    ...
    note VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '计划说明',
...
CREATE TABLE IF NOT EXISTS improvement_note (
    ...
    latest_feedback VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '最近一次反馈内容',
...
CREATE TABLE IF NOT EXISTS album_memory (
    ...
    summary VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '回忆内容',
...
CREATE TABLE IF NOT EXISTS daily_summary (
    ...
    content VARCHAR(1000) NOT NULL COMMENT '最新一条预览内容',
...
CREATE TABLE IF NOT EXISTS daily_summary_entry (
    ...
    content VARCHAR(1000) NOT NULL COMMENT '条目内容',
    creator_username VARCHAR(64) NOT NULL COMMENT '创建账号',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS romantic_plan_item (
    ...
    content VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '条目内容',
