...
function getCurrentUsername() {
	return String(uni.getStorageSync(USER_KEY)?.username || '').trim()
}
...
export function resetThemeSettings() {
	...
	syncProfileThemePreset(defaultThemeSettings.presetKey)
	return { ...defaultThemeSettings }
}

export function getCurrentThemePreset(settings = getThemeSettings()) {
	const presetMap = getThemePresetMap()
...
export function getThemeStyleVars(settings = getThemeSettings()) {
	return { ...getCurrentThemePreset(settings).variables }
}

export function applyTheme(settings = getThemeSettings()) {
...
export function saveAndApplyTheme(settings) {
