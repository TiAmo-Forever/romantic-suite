    ...
    <view v-if="eventList.length" class="event-list app-fade-up app-delay-2">
      ...
      >
        <image
          ...
          mode="aspectFill"
          @click.stop="previewEventCover(item)"
        ></image>
...
.event-summary { margin-top: 12rpx; font-size: 24rpx; line-height: 1.7; color: #9a7682; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; word-break: break-all; min-height: 82rpx; }
.event-footer { margin-top: auto; padding-top: 18rpx; display: flex; align-items: center; justify-content: space-between; gap: 20rpx; }
.event-location { flex: 1; font-size: 22rpx; color: #b18a96; line-height: 1.6; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; word-break: break-all; min-height: 70rpx; }
